          ...
          {offers.map((offer) => (
            ...
            >
              ...
              <div className="relative p-6 md:p-8 flex flex-col items-center text-center">
                ...
                {/* Expiry badge */}
                <span className="inline-block bg-royal-maroon text-royal-cream text-xs font-bold uppercase tracking-wider px-4 py-1.5 rounded-full mb-6 font-[family-name:var(--font-lato)]">
                  {offer.badge}
                </span>
                ...
                <a
                  href="#contact"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-royal-gold text-royal-maroon font-semibold text-sm transition-all duration-300 hover:shadow-lg hover:shadow-royal-gold/30 hover:scale-105 font-[family-name:var(--font-lato)]"
                >
                  Claim Offer
                </a>
              </div>
