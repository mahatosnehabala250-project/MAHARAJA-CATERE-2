      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        <div className="flex items-center justify-center gap-6">
          ...
          <a
            ...
            className="text-[#F5F3EE]/60 hover:text-[#D4A017] transition-colors duration-300"
          ...
          {/* Facebook */}
          <a
            href="https://facebook.com/maharajacaterer"
            target="_blank"
            rel="noopener noreferrer"
            className="text-[#F5F3EE]/60 hover:text-[#D4A017] transition-colors duration-300"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-5">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-[#AAAAAA] font-[family-name:var(--font-lato)]">
            &copy; 2025 Maharaja Caterer. All rights reserved.
          </p>
